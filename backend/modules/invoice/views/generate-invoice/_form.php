...
<div class="generate-invoice-form">
    ...
    <div class="row" style="margin-top: 30px;">
        ...
        <!--        <div class="col-md-4">
        <?php // $form->field($model, 'supplier')->dropDownList(ArrayHelper::map(Contacts::findAll(['status' => 1]), 'id', 'person'), ['prompt' => '-Choose a Supplier-']) ?>
                </div>-->
        <div class="col-md-4">
...
//            'value' => date('Y-m-d'),
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <?= Html::submitButton($model->isNewRecord ? 'Create' : 'Update', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary', 'style' => 'margin-top: 18px;margin-left: 20px;float: right;']) ?>
            </div>
        </div>
    </div>
...
<script>
    $("document").ready(function () {
        ...
        $("#generateinvoice-invoice").select2({
