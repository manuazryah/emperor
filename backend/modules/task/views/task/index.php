...
<div class="demo-index">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php if (count($_GET) == 1) { ?>
                <?= Html::a('<span style="font-weight: bold;color: #03A9F4;">My Task</span>', ['TaskSearch[assigned_to]' => Yii::$app->user->identity->id], ['class' => 'btn btn-white my-task-link', 'style' => 'border: 1px solid #03A9F4;']) ?>
            <?php } else { ?>
...
//                                        'id',
                            ...
                            [
                                'attribute' => 'status',
                                'format' => 'raw',
                                'filter' => [1 => 'Pending', 2 => 'Upcoming', 3 => 'Overdue', 4 => 'Closed'],
                                'value' => function ($model) {
                                    if ($model->status == 1) {
                                        $stat = '<span style="color: green;">Pending</span>';
                                    } elseif ($model->status == 2) {
                                        $stat = '<span style="color: red;">Upcoming</span>';
                                    } elseif ($model->status == 3) {
                                        $stat = '<span style="color: #ffba00;">Overdue</span>';
