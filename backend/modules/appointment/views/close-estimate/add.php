...
//                                                                                                }
                                ...
                                <tr class="formm">
                                    ...
                                    <td><?= $form->field($model, 'tax_id')->dropDownList(ArrayHelper::map(common\models\TaxMaster::findAll(['status' => 1]), 'id', 'name'), ['prompt' => '-Tax-'])->label(false); ?></td>
                            ...
                            $('#closeestimate-service_id').change(function () {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        ...
                                        var iddd = '#closeestimate-tax_id';
                                        $("" + iddd + " option[value='" + res.result['tax'] + "']").prop('selected', true);
//                                        $("#tax_percentage").val(res.result['tax']);
                    ...
                    <script>
                        $(document).ready(function () {
                            $(document).on('keyup mouseup', '#closeestimate-unit_rate', function () {
                                multiply();
                            });
                            $(document).on('keyup mouseup', '#closeestimate-unit', function () {
                                multiply();
                            });
                        });
                        function multiply() {
