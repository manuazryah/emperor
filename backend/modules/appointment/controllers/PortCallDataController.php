...
class PortCallDataController extends Controller {
    ...
    public function portcallReport($data, $label) {
        $arr = [];
        $check = ['id', 'appointment_id', 'additional_info', 'additional_info', 'comments', 'status', 'CB', 'UB', 'DOC', 'DOU', 'eta', 'ets', 'immigration_commenced', 'immigartion_completed', 'fasop', 'cleared_channel', 'eta_next_port', 'cosp', 'cast_off', 'lastline_away', 'pob_outbound','cargo_commenced'];
        $i = 0;
