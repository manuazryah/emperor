...
class Appointment extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['vessel_type', 'vessel', 'port_of_call', 'tug', 'barge', 'nominator', 'terminal', 'charterer', 'shipper', 'stage', 'sub_stages', 'status', 'CB', 'UB', 'estimate_status'], 'integer'],
    ...
    public function getTaxId($principal) {
        $tax_id = '';
        $data = Debtor::findOne(['id' => $principal]);
        if (!empty($data)) {
            if ($data->tax_id != '') {
                $tax_id = 'TRN : ' . $data->tax_id;
            }
        }
        return $tax_id;
    }
